...
var require_react_is_production_min = __commonJS({
  "node_modules/react-is/cjs/react-is.production.min.js"(exports2) {
    ...
    exports2.isValidElementType = function(a) {
      return "string" === typeof a || "function" === typeof a || a === d || a === f2 || a === v || a === e || a === l || a === m || a === w || "object" === typeof a && null !== a && (a.$$typeof === p || a.$$typeof === n2 || a.$$typeof === g2 || a.$$typeof === h || a.$$typeof === k2 || a.$$typeof === u2 || a.$$typeof === q || a[0] === r) ? true : false;
    };
    exports2.typeOf = y;
  }
});
...
var require_string = __commonJS({
  "node_modules/concordance/lib/primitiveValues/string.js"(exports2) {
    ...
    exports2.describe = describe2;
    exports2.deserialize = describe2;
...
var require_describe = __commonJS({
  "node_modules/concordance/lib/describe.js"(exports2, module2) {
    ...
    function describe2(value, options) {
      ...
      const curriedComplex = (c2) => {
        return describeComplex(c2, registry, tryPlugins, describeAny, describeItem, describeMapEntry, describeProperty);
      };
...
var require_diff3 = __commonJS({
  "node_modules/concordance/lib/diff.js"(exports2) {
    ...
    exports2.diffDescriptors = diffDescriptors2;
...
var require_concordance = __commonJS({
  "node_modules/concordance/index.js"(exports2) {
    ...
    exports2.compare = compare2.compare;
    exports2.compareDescriptors = compare2.compareDescriptors;
    exports2.describe = describe2;
    exports2.diff = diff2.diff;
    exports2.diffDescriptors = diff2.diffDescriptors;
    exports2.format = format4.format;
    exports2.formatDescriptor = format4.formatDescriptor;
    exports2.serialize = serialize2.serialize;
    exports2.deserialize = serialize2.deserialize;
  }
});
...
// src/use-cases/authenticate-account-use-case.spec.ts
...
function getConcordanceTheme() {
  ...
  return {
    boolean: c2.yellow,
    circular: c2.gray("[Circular]"),
    date: {
      invalid: c2.red("invalid"),
      value: c2.blue
    },
    diffGutters: {
      actual: `  ${c2.green("-")} `,
    ...
    error: {
      ctor: { open: `${c2.gray.open}(`, close: `)${c2.gray.close}` },
      name: c2.magenta
    },
    function: {
      name: c2.blue,
      stringTag: c2.magenta
    },
    global: c2.magenta,
    item: { after: c2.gray(",") },
    list: { openBracket: c2.gray("["), closeBracket: c2.gray("]") },
    mapEntry: { after: c2.gray(",") },
    maxDepth: c2.gray("\u2026"),
    null: c2.yellow,
    number: c2.yellow,
    object: {
      openBracket: c2.gray("{"),
      closeBracket: c2.gray("}"),
      ctor: c2.magenta,
      stringTag: { open: `${c2.magenta.open}@`, close: c2.magenta.close },
      secondaryStringTag: { open: `${c2.gray.open}@`, close: c2.gray.close }
    },
    property: {
      after: c2.gray(","),
      keyBracket: { open: c2.gray("["), close: c2.gray("]") },
      valueFallback: c2.gray("\u2026")
    },
    regexp: {
      source: { open: `${c2.blue.open}/`, close: `/${c2.blue.close}` },
      flags: c2.yellow
    },
    stats: { separator: c2.gray("---") },
    string: {
      open: c2.blue.open,
      close: c2.blue.close,
      line: { open: c2.blue("'"), close: c2.blue("'") },
      multiline: { start: c2.blue("`"), end: c2.blue("`") },
      controlPicture: c2.gray,
      diff: {
        insert: {
          open: c2.bgGreen.open + c2.black.open,
          close: c2.black.close + c2.bgGreen.close
        },
        delete: {
          open: c2.bgRed.open + c2.black.open,
          close: c2.black.close + c2.bgRed.close
        },
        equal: c2.blue,
        insertLine: {
          open: c2.green.open,
          close: c2.green.close
        },
        deleteLine: {
          open: c2.red.open,
          close: c2.red.close
...
function unifiedDiff(actual, expected, options = {}) {
  ...
  let legend = "";
  if (showLegend) {
    legend = `  ${c2.green(`- Expected  - ${counts["-"]}`)}
  ${c2.red(`+ Received  + ${counts["+"]}`)}
...
function serialize(val, indent = 2, formatOverrides = {}) {
  return normalizeNewlines(
    (0, import_pretty_format4.format)(val, __spreadValues({
      escapeRegex,
      indent,
...
function ensureDirectoryExists(environment, filePath) {
  return __async(this, null, function* () {
    try {
...
`;
    ...
    if (skipWriting)
      return;
    yield ensureDirectoryExists(environment, snapshotPath);
...
describe("Authenticate account user use case", () => {
  beforeEach(() => __async(exports, null, function* () {
    ...
    yield userRepository.create({
      name: "Luan Christian",
      CPF: "13826621655",
      password_hash: yield (0, import_bcryptjs2.hash)("12345678", 8)
    });
  }));
  it("should authenticate a user account", () => __async(exports, null, function* () {
    const { user } = yield authenticateAccountUseCase.execute({
      CPF: "13826621655",
      password: "12345678"
    });
    globalExpect(user.CPF).toEqual("13826621655");
  }));
  it("should not be able to authenticate with wrong CPF", () => __async(exports, null, function* () {
    yield globalExpect(
