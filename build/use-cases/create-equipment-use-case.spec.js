...
// src/use-cases/create-equipment-use-case.spec.ts
...
describe("Create equipment use case", () => {
  ...
  it("should to create a new equipment", () => __async(exports, null, function* () {
    const futureDate = /* @__PURE__ */ new Date();
    futureDate.setMonth(futureDate.getMonth() + 5);
    const { equipment } = yield createEquipmentUseCase.execute({
      name: "Ferramenta 01",
      currentInstallationDate: (/* @__PURE__ */ new Date()).toLocaleDateString(),
      location: "setor 3",
