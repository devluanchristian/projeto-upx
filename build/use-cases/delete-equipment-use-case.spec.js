...
var CreateEquipmentUseCase = class {
  constructor(equipmentRepository2) {
...
// src/use-cases/delete-equipment-use-case.spec.ts
var equipmentRepository;
var deleteEquipmentUseCase;
var createEquipmentUseCase;
describe("Edit equipment use case", () => {
  ...
  it("should edit an equipment", () => __async(exports, null, function* () {
    const createResult = yield createEquipmentUseCase.execute({
      name: "Equipment",
    ...
    globalExpect(equipmentRepository.items).toHaveLength(0);
  }));
});
