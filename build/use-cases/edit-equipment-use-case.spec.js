...
// src/use-cases/edit-equipment-use-case.spec.ts
var equipmentRepository;
var editEquipmentUseCase;
...
describe("Edit equipment use case", () => {
  ...
  it("should edit an equipment", () => __async(exports, null, function* () {
    ...
    const editResult = yield editEquipmentUseCase.execute({
    ...
    globalExpect(editedEquipment.id).toEqual(equipment.id);
  }));
});
